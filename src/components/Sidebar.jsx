    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-b border-zinc-800 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="px-2.5 py-1 text-xs text-zinc-400 hover:text-zinc-100 border border-zinc-800 rounded-full md:hidden transition-colors"
        ...
        <div className="p-4 border-b border-zinc-800 bg-zinc-950/60">
          ...
          <div className="flex items-center justify-between p-3 rounded-2xl border border-zinc-800/80 bg-zinc-900/90">
            ...
            <button
              ...
              className="text-[11px] font-mono text-zinc-300 hover:text-zinc-100 px-2.5 py-1 bg-zinc-800 hover:bg-zinc-700 rounded-full border border-zinc-700 shrink-0 transition-colors"
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `block px-3.5 py-2.5 rounded-xl text-sm transition-all ${
                  isActive
                    ? "bg-zinc-800/90 text-zinc-100 font-semibold border border-zinc-700 shadow-sm"
